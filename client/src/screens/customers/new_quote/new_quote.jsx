...
import { newQuoteStyles } from './new_quote.styles';
...
class NewQuote extends Component {
  ...
  render() {
    ...
    handleCreateCustomerDialogStyle && handleCreateCustomerDialogStyle('Quote');
        ...
        <DialogTitle>
          <div className={classes.dialogFooter}>
            <Button
              ...
              onClick={() => {
                handleCreatePurchaseOrderDialogOpen(parseInt(selectedCustomerId, 10), true)();
                onClose();
              }}
            >
              CREATE QUOTE
...
export default withStyles(newQuoteStyles)(NewQuote);
