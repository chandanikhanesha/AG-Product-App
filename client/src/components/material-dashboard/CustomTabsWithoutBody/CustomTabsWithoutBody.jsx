...
class CustomTabsWithoutBody extends React.Component {
  ...
  render() {
    const { classes, headerColor, plainTabs, tabs, title, rtlActive, print, showPlus, onClickPlus, disable } =
      this.props;
    ...
    return (
      <Card plain={plainTabs} className={`${classes.transparentCard} hide-print`}>
        <CardHeader
          color={headerColor}
          plain={plainTabs}
...
CustomTabsWithoutBody.propTypes = {
...
export default withStyles(styles)(CustomTabsWithoutBody);
